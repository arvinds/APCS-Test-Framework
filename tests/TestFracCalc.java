...
public class TestFracCalc {
  ...
  {
    ps = new ProcessBuilder("java","-cp",System.getProperty("java.class.path"),"FracCalc");
    if(DEBUG){ System.out.println("Now running: java -cp " + System.getProperty("java.class.path") + " FracCalc"); }
  ...
  {    
    ...
    catch(Exception e){ fail("There was an error writing data to the program"); }
  }
